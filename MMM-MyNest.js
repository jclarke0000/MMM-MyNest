...
Module.register("MMM-MyNest",{
  ...
  formatTemp: function (t) {
    ...
    if (tTxt.indexOf(".") != -1) {
      ...
      return "<sup class='blankDecimalSpacer'>" + tempParts[1] + "</sup>" + tempParts[0] + "<sup class='tempDecimal'>" + tempParts[1] + "</sup>";
    } else {
      return tTxt;
    }
  },
  ...
  getDom: function() {
    ...
    if (this.config.displayType === "list") {
      ...
      if (this.hvacMode[this.chosenOne] === 'heat-cool') {
        ...
        wrapper.innerHTML = this.formatTemp(this.targetTemp[this.chosenOne]);
      }
